...
curl_setopt_array($curl_pos, array(
	...
	CURLOPT_POSTFIELDS => "origin=265&destination=".$id_kabupaten."&weight=".$berat."&courier=pos",
...
curl_setopt_array($curl_jne, array(
	...
	CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
	CURLOPT_CUSTOMREQUEST => "POST",
	CURLOPT_POSTFIELDS => "origin=265&destination=".$id_kabupaten."&weight=".$berat."&courier=jne",
	CURLOPT_HTTPHEADER => array(
		"content-type: application/x-www-form-urlencoded",
		"key: 8f22875183c8c65879ef1ed0615d3371"
	),
...
curl_setopt_array($curl_tiki, array(
	...
	CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
	CURLOPT_CUSTOMREQUEST => "POST",
	CURLOPT_POSTFIELDS => "origin=265&destination=".$id_kabupaten."&weight=".$berat."&courier=tiki",
	CURLOPT_HTTPHEADER => array(
		"content-type: application/x-www-form-urlencoded",
		"key: 8f22875183c8c65879ef1ed0615d3371"
	),
