...
<head>
  ...
  <title>Dashboard Admin - Toko Online Alifqy Sport</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>ALIFQY</b>SPORT </span>
        <span class="logo-lg"><b>ALIFQY</b>SPORT </span>
      </a>
...
<!-- 
          <li>
            <a href="grafik.php">
              <i class="fa fa-graph"></i> <span>GRAFIK</span>
            </a>
          </li> 
